    ...
    <section id="home">
      ...
      <div className="lg:max-w-lg lg:w-full md:w-1/2 w-5/6">
        ...
        <div className="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
          <h1 className="title-font sm:text-4xl text-3xl mb-5 ml-10 font-medium max-w-lg">
            About This Site:
          </h1>{" "}
          <p className="ml-10 leading-relaxed mb-5 max-w-lg">
          ...
          <div className="flex justify-center">
            <a
              href="#contact"
              className="ml-10 inline-flex bg-brand-warning border-0 py-2 px-4 text-black focus:outline-none hover:bg-brand-danger 
